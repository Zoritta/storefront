    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='products_in_collection', to='store.collection')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='featured_in_collection', to='store.product'),
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
